...
//		conf.set("zookeeper.znode.parent", "/hbase-unsecure");
		...
		HTableDescriptor tableDescriptor = new HTableDescriptor(TableName.valueOf("employee7"));
		...
		Table table = conn.getTable(TableName.valueOf("employee7"));
